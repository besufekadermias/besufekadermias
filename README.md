...
<!-- ══════════════════════════════════════════════════════════
     ...
     The streak card is generated by your own GitHub Action
     (.github/workflows/streak.yml → assets/streak.svg),
     so it no longer depends on a third-party hosted service.
══════════════════════════════════════════════════════════ -->
...
<img src="assets/streak.svg" width="500" alt="GitHub Streak" />
